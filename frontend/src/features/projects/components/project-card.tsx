...
export function ProjectCard({ project }: ProjectCardProps) {
  return (
    <Link
      ...
      className="group block rounded-lg border border-neutral-200 bg-white p-5 shadow-soft transition-all duration-200 hover:shadow-medium hover:border-primary-200"
    >
