...
export function EmptyChartPlaceholder({
  ...
  return (
    ...
    >
      {icon && (
        <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-linear-to-b from-primary-50 to-neutral-50 ring-1 ring-primary-100/80 text-primary-600">
          {icon}
        </div>
      )}
