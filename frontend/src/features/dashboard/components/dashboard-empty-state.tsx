...
function SetupStep({
  ...
  return (
    <div className="flex items-start gap-3.5 rounded-xl border border-neutral-100 bg-white px-4 py-3.5 shadow-xs transition-colors hover:border-neutral-200">
      {/* Indicator */}
      <div
        className={`mt-0.5 flex h-6 w-6 shrink-0 items-center justify-center rounded-full ${
          done
            ? 'bg-success-100 text-success-600'
            : 'border-2 border-neutral-200 text-transparent'
        }`}
      >
...
function GhostKpiCard({
  ...
  return (
    <div className="flex items-start justify-between rounded-2xl border border-dashed border-neutral-200 bg-white/60 p-5">
      <div>
        <p className="text-[11px] font-semibold uppercase tracking-wider text-neutral-300">{label}</p>
        <p className="mt-2 text-3xl font-bold tabular-nums tracking-tight text-neutral-200">—</p>
        <p className="mt-1 text-sm text-neutral-300">No data yet</p>
      </div>
      <div className={`flex h-10 w-10 shrink-0 items-center justify-center rounded-xl ${iconBg} opacity-40`}>
    ...
    <div className="space-y-6">
      ...
      <header>
        ...
        <p className="mt-1 text-sm text-neutral-500">
          Set up your workspace in a few steps — your dashboard will come to life as you add projects and tasks.
        </p>
      </header>
      ...
      <div className="grid gap-6 lg:grid-cols-12">
        ...
        <div className="lg:col-span-7">
          <div className="rounded-2xl border border-neutral-200 bg-neutral-50/50 p-5 shadow-xs">
            <div className="mb-4 flex items-center justify-between">
              <h2 className="text-sm font-semibold text-neutral-900">Get started</h2>
              <span className="text-xs font-medium text-neutral-400">
                {stepsCompleted} of 3 complete
              </span>
            </div>
        ...
        <div className="lg:col-span-5">
          <div className="flex h-full flex-col rounded-2xl border border-neutral-200 bg-white shadow-xs">
            ...
            <div className="flex flex-1 flex-col items-center justify-center px-6 py-10 text-center">
              ...
              <p className="mt-3 text-sm font-medium text-neutral-700">No activity yet</p>
