...
const variantStyles = {
  primary:
    'bg-primary-600 text-white hover:bg-primary-700 shadow-soft active:scale-[0.98]',
  secondary:
    'bg-white border border-gray-200 text-gray-700 hover:bg-gray-50 shadow-soft',
  danger:
